...
export default function Header() {
  ...
  const { user, logOut } = useAuth(); //pull from context api
...
<HoverCard>
  ...
  <HoverCardContent className="w-80">
    <div className="flex flex-col gap-2">
      ...
      <Button size="sm" variant="outline" onClick={() => router.push("/demographics")}>Edit Profile</Button>
      <Button size = "sm" variant="outline" onClick={() => {logout}}></Button>
    </div>
  </HoverCardContent>
</HoverCard>
